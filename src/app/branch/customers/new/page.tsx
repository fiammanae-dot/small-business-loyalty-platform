...
export default async function NewBranchCustomerPage({
  ...
  return (
    <DashboardShell user={user} eyebrow="Branch Manager" title="Enroll customer">
      <section className="rounded-md border border-[#E5E7EB] bg-white p-5">
        ...
        <form action={createBranchCustomerAction} className="grid gap-5">
          <CsrfInput scope="branch:customers" />
          ...
          <div className="flex gap-3">
            ...
            <Link href="/branch/customers" className="rounded-md border border-[#E5E7EB] px-4 py-2 text-sm font-semibold text-[#111827]">
              Cancel
            </Link>
          </div>
        </form>
