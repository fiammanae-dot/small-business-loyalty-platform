...
function InvoiceHistory({ invoices }: { invoices: Array<{ id: number; invoiceNumber: string; invoiceDate: Date; dueDate: Date; status: InvoiceStatus; amount: Prisma.Decimal; currency: string; payments: Array<{ amount: Prisma.Decimal }>; subscription: { subscriptionPlan: { name: string } } }> }) {
