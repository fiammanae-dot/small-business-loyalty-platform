...
export function DemoRequestForm() {
    ...
    return (
      <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-emerald-900 shadow-sm">
        ...
        <button
          ...
          className="mt-5 rounded-md bg-white px-4 py-2 text-sm font-semibold text-emerald-800 shadow-sm transition hover:bg-emerald-100"
        >
  ...
  return (
    <form
      ...
      className="grid gap-4 rounded-2xl border border-orange-100 bg-white p-5 shadow-2xl shadow-orange-100/70 sm:p-6"
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="grid gap-2 text-sm font-semibold text-[#111827]">
          Business type
          <select name="businessType" required className="h-11 rounded-md border border-[#E5E7EB] bg-white px-3 text-sm outline-none transition focus:border-[#F97316] focus:ring-4 focus:ring-orange-100">
      ...
      <label className="grid gap-2 text-sm font-semibold text-[#111827]">
        ...
        <textarea
          ...
          className="resize-y rounded-md border border-[#E5E7EB] px-3 py-3 text-sm outline-none transition focus:border-[#F97316] focus:ring-4 focus:ring-orange-100"
        />
      </label>
      <button type="submit" className="min-h-11 rounded-md bg-[#F97316] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#EA580C]">
        Request Demo
      </button>
  ...
  return (
    <label className="grid gap-2 text-sm font-semibold text-[#111827]">
      ...
      <input
        ...
        required={required}
        className="h-11 rounded-md border border-[#E5E7EB] px-3 text-sm outline-none transition focus:border-[#F97316] focus:ring-4 focus:ring-orange-100"
      />
    </label>
  );
}
